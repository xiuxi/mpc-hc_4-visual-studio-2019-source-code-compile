...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --x86asmexe=yasm --extra-ldflags=' -LIBPATH:../../../thirdparty/32/lib -LIBPATH:../../../../../../../bin/lib/Debug_Win32 -NODEFAULTLIB:libcmt' --extra-cflags='-D_WIN32_WINNT=0x0600 -DWINVER=0x0600 -Zo -GS- -I../../../thirdparty/32/include -I../../../../../../thirdparty/zlib -MDd' --pkg-config-flags='--static --define-variable=prefix=../../../thirdparty/32' --enable-shared --disable-static --enable-gpl --enable-version3 --disable-autodetect --enable-w32threads --disable-demuxer=matroska --disable-filters --enable-filter='scale,yadif,w3fdif,bwdif' --disable-protocol='async,cache,concat,httpproxy,icecast,md5,subfile' --disable-muxers --enable-muxer=spdif --disable-bsfs --enable-bsf='extract_extradata,vp9_superframe_split' --disable-avdevice --disable-postproc --disable-encoders --disable-devices --disable-programs --disable-doc --enable-avisynth --enable-d3d11va --enable-dxva2 --enable-zlib --build-suffix=-lav --arch=x86 --enable-schannel --enable-debug"
...
#define HAVE_DXVA_PICPARAMS_AV1 1
